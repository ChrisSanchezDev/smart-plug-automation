...
## Scripts:
  * ### scheduler.py:
    * As of now, just scheduled on/off functions are used for the Smart Plugs. This was originally set up to tackle a problem of sometimes forgetting to properly turn on and off fishtank lights, but the on/off function should be useful for other random applications I may have in the future.
